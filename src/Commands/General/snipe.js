...
exports.run = async (Moderation, message, args) => {
    ...
    let kanal = ["794979662027685920"]
if(!kanal.includes(message.channel.id)) return message.reply("Lütfen sadece <#794979662027685920> kanalında komutlarınızı kullanınız.").then(m => m.delete(10000))
